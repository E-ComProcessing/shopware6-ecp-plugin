...
class EcomprocessingGenesisTransactionController extends AbstractController
{
     ...
     */
    #[Route(
        path:     '/api/v{version}/ecomprocessing-v1/genesis/transaction/payment-reference-details',
        name:     'api.ecomprocessing.genesis.version-endpoint.transaction.payment-reference-details',
        defaults: ['_routeScope' => ['api']],
        methods:  ['POST']
    )]
    #[Route(
        path:     '/api/ecomprocessing-v1/genesis/transaction/payment-reference-details',
     ...
     */
    #[Route(
        path:     '/api/v{version}/_action/ecomprocessing-v1/genesis/transaction/capture',
        name:     'api.ecomprocessing.genesis.version-endpoint.transaction.capture',
        defaults: ['_routeScope' => ['api']],
        methods:  ['POST']
    )]
    #[Route(
        path:     '/api/_action/ecomprocessing-v1/genesis/transaction/capture',
     ...
     */
    #[Route(
        path:     '/api/v{version}/_action/ecomprocessing-v1/genesis/transaction/refund',
        name:     'api.ecomprocessing.genesis.version-endpoint.transaction.refund',
        defaults: ['_routeScope' => ['api']],
        methods:  ['POST']
    )]
    #[Route(
        path:     '/api/_action/ecomprocessing-v1/genesis/transaction/refund',
     ...
     */
    #[Route(
        path:     '/api/v{version}/_action/ecomprocessing-v1/genesis/transaction/void',
        name:     'api.ecomprocessing.genesis.version-endpoint.transaction.void',
        defaults: ['_routeScope' => ['api']],
        methods:  ['POST']
    )]
    #[Route(
        path:     '/api/_action/ecomprocessing-v1/genesis/transaction/void',
