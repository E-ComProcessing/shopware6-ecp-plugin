...
namespace Ecomprocessing\Genesis\Service\Payment;

use Ecomprocessing\Genesis\Constants\Config as ConfigKey;
use Ecomprocessing\Genesis\Core\Payment\Transaction\TransactionEntity;
use Ecomprocessing\Genesis\Service\Payment\Exceptions\InvalidGenesisRequest;
use Ecomprocessing\Genesis\Service\Payment\Exceptions\InvalidRequestAttributes;
use Ecomprocessing\Genesis\Service\Payment\Helpers\ThreedsService;
use Ecomprocessing\Genesis\Service\Payment\Transaction as GenesisTransaction;
use Ecomprocessing\Genesis\Service\TokenizationService;
use Ecomprocessing\Genesis\Utils\Config;
use Ecomprocessing\Genesis\Utils\Mappers\PaymentData as PaymentDataMapper;
use Ecomprocessing\Genesis\Utils\Mappers\ReferenceData as ReferenceDataMapper;
...
class Checkout extends Base
{
     ...
     * @throws \Ecomprocessing\Genesis\Utils\Mappers\Exceptions\InvalidPaymentData
     */
    ...
    protected function initializeGenesisConfig(): void
    {
        ...
        GenesisConfig::setEndpoint(Endpoints::ECOMPROCESSING);
