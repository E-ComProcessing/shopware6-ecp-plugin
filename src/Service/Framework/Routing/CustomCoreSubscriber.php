...
namespace Ecomprocessing\Genesis\Service\Framework\Routing;
 ...
 *
 * @package Ecomprocessing\Genesis\Service\Framework\Routing
 */
class CustomCoreSubscriber extends CoreSubscriber
{
    ...
    public function setSecurityHeaders(ResponseEvent $event): void
    {
        ...
        if ($request = $this->requestStack->getCurrentRequest()) {
            ...
            if ($currentRoute === 'frontend.ecomprocessing.return_iframe') {
