...
namespace Ecomprocessing\Genesis\Service;

use Ecomprocessing\Genesis\Constants\ReturnUrl;
    ...
    public function finalize(
        ...
        switch ($status) {
            ...
            case ReturnUrl::CANCEL:
                $message = 'Customer canceled the payment on the Ecomprocessing page.';
