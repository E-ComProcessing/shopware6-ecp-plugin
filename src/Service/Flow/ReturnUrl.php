...
namespace Ecomprocessing\Genesis\Service\Flow;

use Ecomprocessing\Genesis\Constants\Config as ConfigKeys;
use Ecomprocessing\Genesis\Core\Flow\ReturnUrl\ReturnUrlEntity;
...
class ReturnUrl
{
    ...
    public function generateReturnUrl(string $return_url): string
    {
        ...
        return $this->router->generate(
            $this->isIframeEnabled() ? 'frontend.ecomprocessing.return_iframe' : 'frontend.ecomprocessing.return',
            ['token' => $token],
