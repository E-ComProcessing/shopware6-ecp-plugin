...
namespace Ecomprocessing\Genesis\Utils\Mappers;

use Ecomprocessing\Genesis\Constants\ReturnUrl as ReturnUrlStatus;
use Ecomprocessing\Genesis\Service\Flow\ReturnUrl;
use Ecomprocessing\Genesis\Utils\Config;
use Ecomprocessing\Genesis\Utils\Data\PaymentData as PaymentDataModel;
use Ecomprocessing\Genesis\Utils\Mappers\Exceptions\InvalidPaymentData;
        ...
        try {
            ...
            $this->paymentDataModel->setNotificationUrl(
                $this->router->generate(
                    'frontend.ecomprocessing.ipn.checkout',
                    [],
